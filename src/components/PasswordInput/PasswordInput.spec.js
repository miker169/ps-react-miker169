...
test('toggles input when show/hide password is clicked', () => {
  const wrapper = shallow(<PasswordInput htmlId="test" name="test" onChange={() => {}} value="" showVisibilityToggle/>)

  // Password input should have a type of password initiallly
...
test('shows password quality when enabled and a password is enterer', () => {
  const tree = renderer.create(<PasswordInput
    htmlId="test"
    name="test"
    onChange={() => {}}
